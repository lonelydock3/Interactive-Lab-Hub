...
[PiClock_Video](https://youtu.be/I55GrP5OxyI)
...
- add the date
- maybe use the buttons to see the exact time
...
For Lab 2, I decided to add functionality for the user to be able to see the exact time and there is now a feature for the date to be shown at all times.  To see the exact time, the user must hold down both buttons.  Once they let go, the screen will return back to the default time screen.
